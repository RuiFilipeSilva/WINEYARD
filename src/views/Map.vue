  ...
  methods: {
    renderMap() {
      ...
      for (const winerie of this.$store.state.wineries) {
        if (winerie.route == 1) {
          icone =
            "https://github.com/RuiFilipeSilva/WINEYARD/blob/master/src/assets/circuloverde1.png?raw=true";
        } else if (winerie.route == 2) {
          icone =
            "https://github.com/RuiFilipeSilva/WINEYARD/blob/master/src/assets/circuloroxo1.png?raw=true";
        } else {
          icone =
            "https://github.com/RuiFilipeSilva/WINEYARD/blob/master/src/assets/circulovermelho1.png?raw=true";
        }
